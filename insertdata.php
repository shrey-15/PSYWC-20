...
$sql = "INSERT INTO details (first_name,last_name,gender,college,email,mobile,ieee_member_ship,address,city,state,postal_code,price,txn_id) VALUES ('$fname','$lname','$gender','$org','$eaddress','$phone','$ieeemembership','$address1','$city','$state','$code','$price','$TXNID')";
